...
namespace CaptivityEvents.Models
{
    public class CEPlayerCaptivityModel : DefaultPlayerCaptivityModel
    {
        ...
        {
            if (Hero.MainHero.CaptivityStartTime.IsNow && !_capturedEvent) _capturedEvent = true;

            if (!_capturedEvent || !Hero.MainHero.CaptivityStartTime.IsPast) return false;
        ...
        private string DefaultOverridenCheckCaptivityChange(float dt)
        {
            ...
            if (PlayerCaptivity.CaptorParty.IsMobile && PlayerCaptivity.CaptorParty.MobileParty.CurrentSettlement != null)
            {
                ...
                if (CESettings.Instance != null && (PlayerCaptivity.CaptorParty.MapFaction == PlayerCaptivity.CaptorParty.MobileParty.CurrentSettlement.MapFaction && (!CESettings.Instance.SlaveryToggle || PlayerCaptivity.CaptorParty.MobileParty.IsGarrison || PlayerCaptivity.CaptorParty.MobileParty.IsMilitia)))
                {
                    PlayerCaptivity.LastCheckTime = CampaignTime.Now;
