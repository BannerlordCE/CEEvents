...
namespace CaptivityEvents.Config
{
    ...
    public class CESettingsCustom : AttributeGlobalSettings<CESettingsCustom>, ICustomSettingsProvider
    {
        ...
        [SettingPropertyBool("{=CESETTINGS1000}Turn on Captive Events", HintText = "{=CESETTINGS1000}Turn on Captive Events", Order = 1, RequireRestart = true, IsToggle = true)]
        ...
        [SettingPropertyBool("{=CESETTINGS1001}Turn on Captor Events", HintText = "{=CESETTINGS1001}Turn on Captor Events", Order = 1, RequireRestart = true, IsToggle = true)]
        ...
        [SettingPropertyGroup("{=CESETTINGS0098}Captive/{=CESETTINGS0094}Gear")]
        public bool StolenGear { get; set; } = true;
        ...
        [SettingPropertyGroup("{=CESETTINGS0098}Captive/{=CESETTINGS0094}Gear/{=CESETTINGS1090}Outfit")]
        public int BetterOutFitChance { get; set; } = 25;
