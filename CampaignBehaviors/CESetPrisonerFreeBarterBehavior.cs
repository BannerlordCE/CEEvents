    ...
    public class CESetPrisonerFreeBarterBehavior : CampaignBehaviorBase
    {
        ...
        public void CheckForBarters(BarterData args)
        {
            ...
            foreach (CharacterObject characterObject in offererParty.PrisonerHeroes())
            {
                ...
                {
                    if (CESettings.InstanceToCheck != null && ((CESettings.InstanceToCheck.EscapeAutoRansom.SelectedIndex != 0) || !(CESettings.InstanceToCheck.EscapeAutoRansom.SelectedIndex == 1) && (!characterObject.IsPlayerCharacter || offererParty != PartyBase.MainParty)))
                    {
            ...
            foreach (CharacterObject characterObject2 in otherParty.PrisonerHeroes())
            {
                ...
                {
                    if (CESettings.InstanceToCheck != null && ((CESettings.InstanceToCheck.EscapeAutoRansom.SelectedIndex != 0) || !(CESettings.InstanceToCheck.EscapeAutoRansom.SelectedIndex == 1) && (!characterObject2.IsPlayerCharacter || otherParty != PartyBase.MainParty)))
                    {
