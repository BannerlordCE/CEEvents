...
namespace CaptivityEvents.Events {
    internal class CEEventChecker {
        ...
        public static string CheckFlags (CharacterObject captive, PartyBase captorParty = null) {
            ...
            if (atmosphere.SnowInfo.Density > 0) environmentTerrainTypes += "(Snowfall)";
        ...
        private bool WorldMapCheck (PartyBase party, ref bool eventMatchingCondition) {
            ...
            foreach (TerrianTypes terrianTypes in _listEvent.TerrianTypesRequirements)
            {
                ...
                bool hasWorldMapSnowFall = terrianTypes.TerrianType.Contains("SnowFall");

                if (
                    hasWorldMapWater || hasWorldMapMountain || hasWorldMapSnow || hasWorldMapSteppe || hasWorldMapPlain || hasWorldMapDesert || hasWorldMapSwamp || hasWorldMapDune || hasWorldMapBridge || hasWorldMapRiver || hasWorldMapForest || hasWorldMapShallowRiver || hasWorldMapLake || hasWorldMapCanyon || hasWorldMapRuralArea || hasWorldMapSnowFall
                )
                {
                    ...
                    if (hasWorldMapSnowFall) eventMatchingCondition = environmentTerrainTypes.Contains("SnowFall");
