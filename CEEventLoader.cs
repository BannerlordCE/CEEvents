    ...
    internal class CEEventLoader
    {
        ...
        public static string CEWaitingList()
        {
            ...
            if (CESubModule.CEWaitingList != null && CESubModule.CEWaitingList.Count > 0)
            {
                ...
                {
                    CECustomHandler.LogMessage("Waiting Menu: Something is broken?");
                }
            }
        ...
        public static void CELoadRandomEvent(CampaignGameStarter gameStarter, CEEvent listedEvent, List<CEEvent> eventList)
        {
            gameStarter.AddGameMenu(listedEvent.Name, listedEvent.Text, args =>
                                                                        {
                                                                            if (Hero.MainHero.IsFemale) args.MenuContext.SetBackgroundMeshName("wait_prisoner_female");
                                                                            else args.MenuContext.SetBackgroundMeshName("wait_prisoner_male");
                                                                                                            ...
                                                                                                            }, args =>
                                                                                                               {
                                                                                                                   ...
                                                                                                                   if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.GiveXP))
                                                                                                                       try
                                                                                                                       {
                                                                                                                           ...
                                                                                                                           if (op.SkillToLevel != null && op.SkillToLevel != "") skillToLevel = op.SkillToLevel;
                                                                                                                           else if (listedEvent.SkillToLevel != null && listedEvent.SkillToLevel != "") skillToLevel = listedEvent.SkillToLevel;
                                                                                                                   ...
                                                                                                                   if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeTrait))
                                                                                                                       try
                                                                                                                       {
                                                                                                                           ...
                                                                                                                           if (op.TraitTotal != null && op.TraitTotal != "") level = GetIntFromXML(op.TraitTotal);
                                                                                                                           else if (listedEvent.TraitTotal != null && listedEvent.TraitTotal != "") level = GetIntFromXML(listedEvent.TraitTotal);
                                                                                                                           else CECustomHandler.LogToFile("Missing Trait TraitTotal");

                                                                                                                           if (op.TraitToLevel != null && op.TraitToLevel != "") TraitModifier(Hero.MainHero, op.TraitToLevel, level);
                                                                                                                           else if (listedEvent.TraitToLevel != null && listedEvent.TraitToLevel != "") TraitModifier(Hero.MainHero, listedEvent.TraitToLevel, level);
                                                                                                                   ...
                                                                                                                   else if (op.TriggerEvents != null && op.TriggerEvents.Length > 0)
                                                                                                                   {
                                                                                                                       ...
                                                                                                                       try
                                                                                                                       {
                                                                                                                           foreach (var triggerEvent in op.TriggerEvents)
                                                                                                                           {
                                                                                                                               ...
                                                                                                                               {
                                                                                                                                   CECustomHandler.LogMessage("Couldn't find " + triggerEvent.EventName + " in events.");
                                                                                                                               ...
                                                                                                                               try
                                                                                                                               {
                                                                                                                                   if (!triggerEvent.EventWeight.IsStringNoneOrEmpty()) weightedChance = GetIntFromXML(triggerEvent.EventWeight);
                                                                                                                                   else weightedChance = GetIntFromXML(triggeredEvent.WeightedChanceOfOccuring);
                                                                                                                               }
                                                                                                                               catch (Exception)
                                                                                                                               {
                                                                                                                           ...
                                                                                                                           if (eventNames.Count > 0)
                                                                                                                           {
                                                                                                                               ...
                                                                                                                               {
                                                                                                                                   CECustomHandler.LogMessage("Couldn't find " + eventNames[number] + " in events.");
                                                                                                                   ...
                                                                                                                   else if (op.TriggerEventName != null && op.TriggerEventName != "")
                                                                                                                   {
                                                                                                                       ...
                                                                                                                       {
                                                                                                                           CECustomHandler.LogMessage("Couldn't find " + op.TriggerEventName + " in events.");
                                                                                                                           CECaptorContinue(args);
                                                                                                                       }
                                                                                                                   }
                                                                                                                   else
                ...
                gameStarter.AddWaitGameMenu(listedEvent.Name, listedEvent.Text, args =>
                                                                                {
                                                                                    ...
                                                                                    try
                                                                                    {
                                                                                        ...
                                                                                        else if (listedEvent.BackgroundAnimation != null && listedEvent.BackgroundAnimation.Count > 0)
                                                                                        {
                                                                                            ...
                                                                                            {
                                                                                                CECustomHandler.LogMessage("Failed to load BackgroundAnimationSpeed for " + listedEvent.Name + " : Exception: " + e);
                                                                                            }
                                                                                    ...
                                                                                    {
                                                                                        CECustomHandler.LogMessage("Failed to load background for " + listedEvent.Name);
                                                                                    }
                ...
                gameStarter.AddGameMenuOption(listedEvent.Name, listedEvent.Name + op.Order, op.OptionText, args =>
                                                                                                            {
                                                                                                                ...
                                                                                                                if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeCaptorGold))
                                                                                                                    try
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        if (op.CaptorGoldTotal != null && op.CaptorGoldTotal != "") level = GetIntFromXML(op.CaptorGoldTotal);
                                                                                                                        else if (listedEvent.CaptorGoldTotal != null && listedEvent.CaptorGoldTotal != "") level = GetIntFromXML(listedEvent.CaptorGoldTotal);
                                                                                                                ...
                                                                                                                if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.SoldToSettlement))
                                                                                                                    try
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        if (!PlayerCaptivity.CaptorParty.IsSettlement) party = PlayerCaptivity.CaptorParty.MobileParty.CurrentSettlement.Party;
                                                                                                                        else party = PlayerCaptivity.CaptorParty;
                                                                                                                        MBTextManager.SetTextVariable("BUYERSETTLEMENT", party.Name);
                                                                                                                    }
                                                                                                                    catch (Exception)
                                                                                                                    {
                                                                                                                ...
                                                                                                                if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.SoldToCaravan))
                                                                                                                    try
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        if (PlayerCaptivity.CaptorParty.IsSettlement) party = PlayerCaptivity.CaptorParty.Settlement.Parties.First(mobileParty => { return mobileParty.IsCaravan; }).Party;
                                                                                                                        else party = PlayerCaptivity.CaptorParty.MobileParty.CurrentSettlement.Parties.First(mobileParty => { return mobileParty.IsCaravan; }).Party;
                                                                                                                ...
                                                                                                                if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.SoldToLordParty))
                                                                                                                    try
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        if (PlayerCaptivity.CaptorParty.IsSettlement) party = PlayerCaptivity.CaptorParty.Settlement.Parties.First(mobileParty => { return mobileParty.IsLordParty; }).Party;
                                                                                                                        else party = PlayerCaptivity.CaptorParty.MobileParty.CurrentSettlement.Parties.First(mobileParty => { return mobileParty.IsLordParty; }).Party;
                                                                                                            ...
                                                                                                            }, args =>
                                                                                                               {
                                                                                                                   ...
                                                                                                                   if (!PlayerCaptivity.CaptorParty.IsSettlement && PlayerCaptivity.CaptorParty.IsMobile && PlayerCaptivity.CaptorParty.MobileParty.LeaderHero != null)
                                                                                                                   {
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeRelation))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.RelationTotal != null && op.RelationTotal != "") RelationsModifier(PlayerCaptivity.CaptorParty.MobileParty.LeaderHero, GetIntFromXML(op.RelationTotal));
                                                                                                                               else RelationsModifier(PlayerCaptivity.CaptorParty.MobileParty.LeaderHero, GetIntFromXML(listedEvent.RelationTotal));
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeCaptorTrait))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               ...
                                                                                                                               if (op.TraitTotal != null && op.TraitTotal != "") level = GetIntFromXML(op.TraitTotal);
                                                                                                                               else level = GetIntFromXML(listedEvent.TraitTotal);

                                                                                                                               if (op.TraitToLevel != null && op.TraitToLevel != "") TraitModifier(PlayerCaptivity.CaptorParty.LeaderHero, op.TraitToLevel, level);
                                                                                                                               else TraitModifier(PlayerCaptivity.CaptorParty.LeaderHero, listedEvent.TraitToLevel, level);
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeCaptorRenown))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.RenownTotal != null && op.RenownTotal != "") RenownModifier(GetIntFromXML(op.RenownTotal), PlayerCaptivity.CaptorParty.LeaderHero);
                                                                                                                   ...
                                                                                                                   if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.SoldToLordParty))
                                                                                                                       try
                                                                                                                       {
                                                                                                                           ...
                                                                                                                           if (PlayerCaptivity.CaptorParty.IsSettlement) party = PlayerCaptivity.CaptorParty.Settlement.Parties.FirstOrDefault(mobileParty => { return mobileParty.IsLordParty; });
                                                                                                                           else party = PlayerCaptivity.CaptorParty.MobileParty.CurrentSettlement.Parties.FirstOrDefault(mobileParty => { return mobileParty.IsLordParty; });
                                                                                                                   ...
                                                                                                                   if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.SoldToNotable))
                                                                                                                       try
                                                                                                                       {
                                                                                                                           ...
                                                                                                                           if (PlayerCaptivity.CaptorParty.IsSettlement) settlement = PlayerCaptivity.CaptorParty.Settlement;
                                                                                                                           else settlement = PlayerCaptivity.CaptorParty.MobileParty.CurrentSettlement;
                                                                                                                   ...
                                                                                                                   else if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.AttemptEscape))
                                                                                                                   {
                                                                                                                       try
                                                                                                                       {
                                                                                                                           if (op.EscapeChance != null && op.EscapeChance != "") CECaptivityEscapeAttempt(args, GetIntFromXML(op.EscapeChance));
            ...
            gameStarter.AddGameMenu(listedEvent.Name, listedEvent.Text, args =>
                                                                        {
                                                                            ...
                                                                            {
                                                                                CECustomHandler.LogMessage("Background failed to load on " + listedEvent.Name);
                                                                            }
                                                                        });
                ...
                gameStarter.AddGameMenuOption(listedEvent.Name, listedEvent.Name + op.Order, op.OptionText, args =>
                                                                                                            {
                                                                                                                ...
                                                                                                                if (!op.ReqHeroSkill.IsStringNoneOrEmpty())
                                                                                                                {
                                                                                                                    ...
                                                                                                                    try
                                                                                                                    {
                                                                                                                        SkillLevel = listedEvent.Captive.GetSkillValue(SkillObject.FindFirst(skill => { return skill.StringId == op.ReqHeroSkill; }));
                                                                                                                    }
                                                                                                                    catch (Exception)
                                                                                                                    {
                                                                                                                        CECustomHandler.LogToFile("Invalid Skill Captive");
                                                                                                                ...
                                                                                                                if (!op.ReqCaptorSkill.IsStringNoneOrEmpty())
                                                                                                                {
                                                                                                                    ...
                                                                                                                    try
                                                                                                                    {
                                                                                                                        SkillLevel = Hero.MainHero.GetSkillValue(SkillObject.FindFirst(skill => { return skill.StringId == op.ReqCaptorSkill; }));
                                                                                                                    }
                                                                                                                    catch (Exception)
                                                                                                                    {
                                                                                                                        CECustomHandler.LogToFile("Invalid Skill Captor");
                                                                                                            ...
                                                                                                            }, args =>
                                                                                                               {
                                                                                                                   ...
                                                                                                                   if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeCaptorTrait))
                                                                                                                       try
                                                                                                                       {
                                                                                                                           ...
                                                                                                                           if (op.TraitToLevel != null && op.TraitToLevel != "") TraitModifier(Hero.MainHero, op.TraitToLevel, level);
                                                                                                                           else TraitModifier(Hero.MainHero, listedEvent.TraitToLevel, level);
                                                                                                                       }
                                                                                                                       catch (Exception)
                                                                                                                       {
                                                                                                                           CECustomHandler.LogToFile("Missing Trait Flags");
                                                                                                                   ...
                                                                                                                   if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeCaptorRenown))
                                                                                                                       try
                                                                                                                       {
                                                                                                                           if (op.RenownTotal != null && op.RenownTotal != "") RenownModifier(GetIntFromXML(op.RenownTotal), Hero.MainHero);
                                                                                                                           else RenownModifier(GetIntFromXML(listedEvent.RenownTotal), Hero.MainHero);
                                                                                                                       }
                                                                                                                       catch (Exception)
                                                                                                                       {
                                                                                                                           CECustomHandler.LogToFile("Missing RenownTotal");
                                                                                                                   ...
                                                                                                                   if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeMorale))
                                                                                                                       try
                                                                                                                       {
                                                                                                                           if (op.MoraleTotal != null && op.MoraleTotal != "") MoralChange(GetIntFromXML(op.MoraleTotal), PartyBase.MainParty);
                                                                                                                           else MoralChange(GetIntFromXML(listedEvent.MoraleTotal), PartyBase.MainParty);
                                                                                                                       }
                                                                                                                       catch (Exception)
                                                                                                                       {
                                                                                                                           CECustomHandler.LogToFile("Missing MoralTotal");
                                                                                                                   ...
                                                                                                                   if (captiveHero != null)
                                                                                                                   {
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeSlaveryLevel))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.SlaveryTotal != null && op.SlaveryTotal != "") VictimSlaveryModifier(GetIntFromXML(op.SlaveryTotal), captiveHero);
                                                                                                                               else VictimSlaveryModifier(GetIntFromXML(listedEvent.SlaveryTotal), captiveHero);
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing SlaveryTotal");
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeProstitutionLevel))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.ProstitutionTotal != null && op.ProstitutionTotal != "") VictimProstitutionModifier(GetIntFromXML(op.ProstitutionTotal), captiveHero);
                                                                                                                               else VictimProstitutionModifier(GetIntFromXML(listedEvent.ProstitutionTotal), captiveHero);
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing ProstitutionTotal");
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeRelation))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.RelationTotal != null && op.RelationTotal != "") RelationsModifier(captiveHero, GetIntFromXML(op.RelationTotal));
                                                                                                                               else RelationsModifier(captiveHero, GetIntFromXML(listedEvent.RelationTotal));
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing RelationTotal");
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeTrait))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               ...
                                                                                                                               if (op.TraitToLevel != null && op.TraitToLevel != "") TraitModifier(captiveHero, op.TraitToLevel, level);
                                                                                                                               else TraitModifier(captiveHero, listedEvent.TraitToLevel, level);
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing Trait Flags");
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeRenown))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.RenownTotal != null && op.RenownTotal != "") RenownModifier(GetIntFromXML(op.RenownTotal), captiveHero);
                                                                                                                               else RenownModifier(GetIntFromXML(listedEvent.RenownTotal), captiveHero);
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing RenownTotal");
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ChangeHealth))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.HealthTotal != null && op.HealthTotal != "") captiveHero.HitPoints += GetIntFromXML(op.HealthTotal);
                                                                                                                               else captiveHero.HitPoints += GetIntFromXML(listedEvent.HealthTotal);
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing HealthTotal");
                                                                                                                       ...
                                                                                                                       if (op.MultipleRestrictedListOfConsequences.Contains(RestrictedListOfConsequences.ImpregnationHero))
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.PregnancyRiskModifier != null && op.PregnancyRiskModifier != "") CaptivityImpregnationChance(captiveHero, GetIntFromXML(op.PregnancyRiskModifier));
                                                                                                                               else CaptivityImpregnationChance(captiveHero, GetIntFromXML(listedEvent.PregnancyRiskModifier));
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing PregnancyRiskModifier");
                                                                                                                           ...
                                                                                                                           try
                                                                                                                           {
                                                                                                                               if (op.PregnancyRiskModifier != null && op.PregnancyRiskModifier != "") CaptivityImpregnationChance(captiveHero, GetIntFromXML(op.PregnancyRiskModifier), false, false);
                                                                                                                               else CaptivityImpregnationChance(captiveHero, GetIntFromXML(listedEvent.PregnancyRiskModifier), false, false);
                                                                                                                           }
                                                                                                                           catch (Exception)
                                                                                                                           {
                                                                                                                               CECustomHandler.LogToFile("Missing PregnancyRiskModifier");
        ...
        private static void CECaptivityContinue(MenuCallbackArgs args)
        {
            ...
            {
                CECustomHandler.LogMessage("Critical Error: CECaptivityContinue : " + e);
            }
        }
        ...
        {
            CESubModule.LoadTexture("default");
            var _captorParty = PlayerCaptivity.CaptorParty;
            CECampaignBehavior.ExtraProps.Owner = null;
            ...
            if (_captorParty.IsSettlement && _captorParty.Settlement.IsTown)
                try
                {
                    ...
                    if (_captorParty.IsActive) _captorParty.PrisonRoster.RemoveTroop(Hero.MainHero.CharacterObject);
        ...
        private static void CEPrisonerRebel(MenuCallbackArgs args)
        {
            ...
            if (!releasedPrisoners.IsEmpty())
                try
                {
                    ...
                    var leader = releasedPrisoners.FirstOrDefault(hasHero => { return hasHero.Character.IsHero; });

                    if (leader.Character != null)
                    {
                        var clan = leader.Character.HeroObject.Clan;
                        var defaultPartyTemplate = clan.DefaultPartyTemplate;
                        var nearest = SettlementHelper.FindNearestSettlement(settlement => { return settlement.OwnerClan == clan; });
                        if (nearest == null) nearest = SettlementHelper.FindNearestSettlement(settlement => { return true; });
        ...
        public static int GetIntFromXML(string numpassed)
        {
            ...
            {
                CECustomHandler.LogMessage("Failed to parse " + numpassed);
        ...
        private static void CEKillPlayer(Hero killer)
        {
            ...
            {
                CECustomHandler.LogMessage("Failed CEKillPlayer " + e);
            }
        }
        ...
        private static void TraitModifier(Hero hero, string trait, int amount = 0)
        {
            ...
            if (!found)
            {
                ...
                if (!found) CECustomHandler.LogMessage("Unable to find : " + trait);
            }
        }
        ...
        private static void RenownModifier(int amount, Hero hero)
        {
            if (hero != null && amount != 0)
            {
                ...
                if (hero.Clan.Renown < CESettings.Instance.RenownMin) hero.Clan.Renown = CESettings.Instance.RenownMin;
        ...
        public static void ImpregnationChance(Hero targetHero, int modifier = 0, bool forcePreg = false, Hero senderHero = null)
        {
            if (targetHero != null && targetHero.IsFemale && !targetHero.IsPregnant)
            {
                if (IsHeroAgeSuitableForPregnancy(targetHero) && CESettings.Instance.PregnancyToggle)
                {
                            ...
                            : CESettings.Instance.PregnancyChance + modifier))
                    {
                        ...
                        else if (targetHero.CurrentSettlement != null && targetHero.CurrentSettlement.MilitaParty != null && !targetHero.CurrentSettlement.MilitaParty.MemberRoster.IsEmpty())
                        {
                            ...
                            var maleMembers = settlementCurrent.MilitaParty.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale == false; });

                            if (maleMembers.Count() == 0) return;

                            var m = maleMembers.GetRandomElement().Character;
                        ...
                        {
                            var maleMembers = targetHero.PartyBelongedTo.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale == false; });
                        ...
                        {
                            var m = CharacterObject.Templates.Where(characterObject => { return characterObject.IsFemale == false && characterObject.Occupation == Occupation.Outlaw; }).GetRandomElement();
                        ...
                        CEContext.spouseOne = randomSoldier;
                        CEContext.spouseTwo = targetHero;
                        MakePregnantAction.Apply(targetHero);
                        CEContext.spouseOne = CEContext.spouseTwo = null;
                ...
                {
                    var m = CharacterObject.Templates.Where(characterObject => { return characterObject.IsFemale == false; }).GetRandomElement();
            ...
            else if (targetHero != null && !targetHero.IsFemale)
            {
                if (CESettings.Instance.PregnancyToggle)
                {
                            ...
                            : CESettings.Instance.PregnancyChance + modifier))
                    {
                        ...
                        {
                            var settlementCurrent = targetHero.CurrentSettlement;
                            var femaleMembers = settlementCurrent.MilitaParty.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale; });

                            if (femaleMembers.Count() == 0) return;

                            do
                            {
                                var m = femaleMembers.GetRandomElement().Character;
                        ...
                        {
                            var femaleMembers = targetHero.PartyBelongedTo.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale; });
                        ...
                        {
                            var m = CharacterObject.Templates.Where(characterObject => { return characterObject.IsFemale && characterObject.Occupation == Occupation.Outlaw; }).GetRandomElement();
            ...
            if (targetHero != null && targetHero.IsFemale && !targetHero.IsPregnant)
            {
                if (IsHeroAgeSuitableForPregnancy(targetHero) && CESettings.Instance.PregnancyToggle)
                {
                            ...
                            : CESettings.Instance.PregnancyChance + modifier))
                    {
                        ...
                        {
                            var maleMembers = targetHero.PartyBelongedToAsPrisoner.MobileParty.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale == false; });
                        ...
                        else if (targetHero.PartyBelongedToAsPrisoner.IsSettlement && targetHero.PartyBelongedToAsPrisoner.Settlement.MilitaParty != null && !targetHero.PartyBelongedToAsPrisoner.Settlement.MilitaParty.MemberRoster.IsEmpty())
                        {
                            ...
                            var maleMembers = playerCaptor.MilitaParty.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale == false; });
            ...
            else if (targetHero != null && !targetHero.IsFemale)
            {
                if (CESettings.Instance.PregnancyToggle)
                {
                            ...
                            : CESettings.Instance.PregnancyChance + modifier))
                    {
                        ...
                        {
                            var femaleMembers = targetHero.PartyBelongedToAsPrisoner.MobileParty.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale; });
                        ...
                        {
                            var playerCaptor = targetHero.PartyBelongedToAsPrisoner.Settlement;
                            var femaleMembers = playerCaptor.MilitaParty.MemberRoster.Where(characterObject => { return characterObject.Character.IsFemale; });
