...
namespace CaptivityEvents
{
    internal class CEPrisonerDialogue
    {
        public void AddPrisonerLines(CampaignGameStarter campaignGameStarter)
        {
            ...
            //if (CESettings.InstanceToCheck.ProstitutionControl) campaignGameStarter.AddPlayerLine("CEPrisonerInCell_02", "CEPrisonerInCell", "CEPrisonerInCell_01_response", "{=CEBROTHEL0979}Time to make you work at the brothel.", , null);
